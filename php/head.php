...
<head>
	...
	<link rel="stylesheet" href="/php/css_concat.php?page=<?php echo substr($_SERVER['REQUEST_URI'], 1) ?>">
    ...
    <script src="/php/js_concat.php?page=<?php echo substr($_SERVER['REQUEST_URI'], 1) ?>" defer></script>
</head>
